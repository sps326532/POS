...
<div>
  ...
  <div class="nowrap bigmargin">
    ...
    <button id="backToshop" onclick="window.scrollTo(0, y)">繼續選擇</button>
...
function AddItem(AddId){
  if(AddId == 0)Ui.id('items').value = "紅茶:30"
  else if(AddId == 1)Ui.id('items').value = "綠茶:30"
  else if(AddId == 2)Ui.id('items').value = "汽水:25"
  Pos.calcPrice()
  var y = pageYOffset
